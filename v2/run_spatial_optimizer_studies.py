...
def _run_meta_optimizer_study(
    *,
    ...
    for seed in seeds:
        run_name = f"{args.run_name_prefix}_meta_seed{int(seed)}"
...
def _run_search_algorithm_study(
    *,
    ...
    for seed in seeds:
        run_name = f"{args.run_name_prefix}_search_seed{int(seed)}"
        config = _build_train_config(
            args=args,
            seed=int(seed),
            run_name=run_name,
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Disable success-threshold curriculum for meta-optimizer training runs.",
    )
