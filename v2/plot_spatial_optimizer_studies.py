...
from v2.run_spatial_optimizer_studies import (
...
def plot_from_manifest(
    *,
    ...
    summary = {
        ...
        "plot_cmd": f"python3 -m v2.plot_spatial_optimizer_studies --manifest {manifest_path}",
    }
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Regenerate optimizer-study plots from v2.run_spatial_optimizer_studies manifest."
    )
    parser.add_argument(
        "--manifest",
        type=str,
        required=True,
        help="Path to manifest.json created by v2.run_spatial_optimizer_studies.",
    )
    parser.add_argument(
        "--output_root",
        type=str,
