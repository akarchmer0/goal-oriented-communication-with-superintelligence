...
matrix constraint, which is critical for d >= 4 where N_pos can be large.
"""
...
def solve_sdp_oracle(
    ...
    # then stack the per-variable contributions into sparse matrices
    # A_real_flat (NN x N_pos) and B_imag_flat (NN x N_pos).
    #
    # The moment matrix entries are then:
    #   M_real_flat = M_0_real_flat + A_real_flat @ alpha
    #   M_imag_flat = M_0_imag_flat + B_imag_flat @ beta
