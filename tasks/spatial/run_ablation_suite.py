...
from .train import _resolve_device, run_training
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description=(
            ...
            "Plots can be generated or regenerated with tasks.spatial.plot_ablations."
        )
    )
    parser.add_argument(
        "--seeds",
    ...
    parser.add_argument(
        "--skip_plotting",
        action="store_true",
        help="Skip automatic plotting; use tasks.spatial.plot_ablations on the manifest later.",
    )
...
def main() -> None:
    ...
    if args.skip_plotting:
        ...
        from .plot_ablations import plot_from_manifest
