...
Usage:
    python -m tasks.graph.compute_aggregate_episodes_to_80 --manifest plots/requested_experiments_manifest_S0_n10000_w500_seeds30.json
"""
...
def main() -> None:
    ...
    if any(r[1] is None for r in results):
        print()
        print(
            "Note: Some runs have no metrics. Ensure the run directories contain "
            "metrics.jsonl from the experiment."
        )
