...
from .config import PlotConfig, RequestedExperimentsConfig
...
def main() -> None:
    ...
    _plot_learning_curves_with_ci(
        ...
        title="Experiment 1: Superintelligence Language with Baselines",
        max_points=args.max_points,
    )
    _plot_path_length_curves_with_ci(
        series=exp1_series,
        output_path=plotdir
        / f"exp1_encoding_path_length_{sensing}_n{n}_w{running_avg_window}_seeds{num_seeds}_ci95.png",
        title="Experiment 1: Path Length Comparison",
        max_points=args.max_points,
    )
    ...
    _plot_learning_curves_with_ci(
        series=exp2_series,
        output_path=plotdir
        / f"exp2_graph_scaling_{sensing}_w{running_avg_window}_seeds{num_seeds}_ci95.png",
        title="Experiment 2: Graph-size Scaling",
        max_points=args.max_points,
    ...
    _plot_path_length_curves_with_ci(
        series=exp2_series,
        output_path=plotdir
        / f"exp2_graph_scaling_path_length_{sensing}_w{running_avg_window}_seeds{num_seeds}_ci95.png",
        title="Experiment 2: Graph-size Path Length",
        max_points=args.max_points,
        colors=viridis_colors,
    )
    exp2_summary = {
    ...
    _plot_learning_curves_with_ci(
        series=exp3_series,
        output_path=plotdir
        / f"exp3_adversarial_lie_rate_{sensing}_n{n}_w{running_avg_window}_seeds{num_seeds}_ci95.png",
        title="Experiment 3: Noisy Superintelligence",
        max_points=args.max_points,
    )
    _plot_path_length_curves_with_ci(
        series=exp3_series,
        output_path=plotdir
        / f"exp3_adversarial_lie_rate_path_length_{sensing}_n{n}_w{running_avg_window}_seeds{num_seeds}_ci95.png",
        title="Experiment 3: Noisy Superintelligence",
        max_points=args.max_points,
    )
    ...
    for sigma in sorted(set(noise_sigmas)):
        ...
        manifest_key = _resolve_manifest_key(
            exp4_manifest, f"sigma={sigma:g}", f"\u03c3={sigma:g}", display_label,
        )
        if manifest_key is None:
            continue
    ...
    if binary_key is not None:
        exp4_series.append((binary_label, _load_seed_metrics(exp4_manifest[binary_key])))
    _plot_learning_curves_with_ci(
        series=exp4_series,
        output_path=plotdir
        / f"exp4_noisy_sensing_{sensing}_n{n}_w{running_avg_window}_seeds{num_seeds}_ci95.png",
        title="Experiment 4: Noisy Sensing and Binary Signal",
        max_points=args.max_points,
    )
    ...
    _plot_learning_curves_with_ci(
        series=exp5_series,
        output_path=plotdir
        / f"exp5_fst_k_sweep_{sensing}_n{n}_w{running_avg_window}_seeds{num_seeds}_ci95.png",
        title="Experiment 5: Hidden State Size Sweep",
        max_points=args.max_points,
    ...
    _plot_learning_curves_with_ci(
        series=exp6_series,
        output_path=plotdir
        / f"exp6_degree_sweep_{sensing}_n{n}_w{running_avg_window}_seeds{num_seeds}_ci95.png",
        title="Experiment 6: Graph Degree Sweep",
        max_points=args.max_points,
    ...
    _plot_path_length_curves_with_ci(
        series=exp6_series,
        output_path=plotdir
        / f"exp6_degree_sweep_path_length_{sensing}_n{n}_w{running_avg_window}_seeds{num_seeds}_ci95.png",
        title="Experiment 6: Graph Degree Path Length",
        max_points=args.max_points,
        colors=viridis_degree_colors,
    )
